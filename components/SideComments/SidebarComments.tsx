          ...
          {commentsData.map((obj: any) => (
              <div   key={obj.id} className='my-4'>
                  <div  className='flex flex-col'>
                      <div onClick={() => router.push(`/profile/${obj.user.id}`)} className='flex space-x-2 cursor-pointer'>
                      ...
                      <div>
                          <p onClick={() => router.push(`/news/${obj.user.id}`)} className='text-xs font-semibold text-gray-800 cursor-pointer'>{obj.post.title}</p>
                      </div>
                  </div>
              </div>
          ))}
